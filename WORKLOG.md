...
**Current phase:** **Part 3 — CI/CD & GitOps: step 1 (CI lint + test + Dependabot) done and verified live on real GitHub Actions, 2026-08-23.** Plan: `docs/planning/part-03-cicd-gitops.md` (design `db4abba`). Branch `feature/gitops-ci-cd`, draft [PR #3](https://github.com/IdanBro/PokeProxy/pull/3) open against `main` as the vehicle for the rest of Part 3. Step 2 (build/scan/sign/push to GHCR) is next.
