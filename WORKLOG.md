...
**S4 still open**, plus **six NICE TO HAVE** (N1–N6), listed in the planning doc's audit section. S4: `values-prod.yaml` renders rules pointing at the mock Service it disables — already documented, but a `fail` would turn a runtime 502 into a render-time error.
